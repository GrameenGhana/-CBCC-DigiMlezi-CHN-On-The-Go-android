...
import org.cbccessence.cch.popupquestions.XmlGuiExpandableListview;
import org.cbccessence.cch.popupquestions.XmlGuiForm;
import org.cbccessence.cch.popupquestions.XmlGuiFormField;
import org.cbccessence.cch.popupquestions.XmlGuiImage;
import org.cbccessence.cch.popupquestions.XmlGuiListView;
import org.cbccessence.cch.popupquestions.XmlGuiSectionHeader;
import org.cbccessence.cch.popupquestions.XmlGuiSubSection;
import org.cbccessence.cch.popupquestions.XmlGuiSubSubSectionTextView;
import org.cbccessence.cch.popupquestions.XmlGuiTakeFirstActionHeader;
import org.cbccessence.cch.popupquestions.XmlGuiTakeTransportActionHeader;
import org.cbccessence.cch.popupquestions.XmlGuiTextViewChoice;
import org.cbccessence.cch.popupquestions.XmlGuiTextViewQuestion;
...
public class POCDynamicActivity extends BaseActivity {
    ...
    String secName;
    String subSecName;
    String TAG = POCDynamicActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (extras != null) {
            ...
            secName = extras.getString("sectionName");
            subSecName = extras.getString("subSectionName");
	...
	private class GetData extends AsyncTask<String, Void, XmlGuiForm> {
		...
		protected XmlGuiForm doInBackground(String... params) {
			try {
                ...
                Log.i("Background Task"," File location is " + xmlFile);
                ...
                Log.i("Background Task"," Root element " + root);

                Log.i(tag,"DOCUMENT *** " + dom);
                Log.i(tag, "ELEMENT ROOT *** " + root);
	    ...
	    protected void onPostExecute(XmlGuiForm result) {
			...
			Log.i(tag, "Result of the form " + result);
			DisplayForm(result);
    ...
    @SuppressLint("NewApi")
    private boolean DisplayForm(XmlGuiForm theForm)
    {
    ...
    public void onStop(){
        ...
        try {
            ...
            log.put("section", secName);
            log.put("sub_section", subSecName );
            log.put("topic", shortname);
