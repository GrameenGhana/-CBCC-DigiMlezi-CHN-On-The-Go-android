...
public class RecyclerItemViewAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((PocSectionsAdapter.PocSectionsViewHolder) viewHolder);
                return false;
            }
    ...
    private void runEnterAnimation(final PocSectionsAdapter.PocSectionsViewHolder holder) {
