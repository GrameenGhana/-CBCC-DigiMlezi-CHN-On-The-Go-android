...
public class PrefsActivity extends AppActivity implements SharedPreferences.OnSharedPreferenceChangeListener, MoveStorageListener {
    ...
    public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equalsIgnoreCase(PREF_STORAGE_OPTION)) {
            ...
            if (protectionEnabled){
                ...
                final AlertDialog passwordDialog = new AlertDialog.Builder(this, R.style.AppAlertDialog)
            ...
            ComponentName adminReceiver = new ComponentName(this, org.digitalcampus.oppia.application.AdminReceiver.class);
            if (adminEnabled){
    ...
    private void executeChangeStorageTask(String path, String storageOption){
        ...
        pDialog = new ProgressDialog(this, R.style.AppDialog);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case ADMIN_ACTIVATION_REQUEST:
                ...
                SharedPreferences.Editor editor = prefs.edit();
                editor.putBoolean(PrefsActivity.PREF_REMOTE_ADMIN, adminEnabled).apply();
