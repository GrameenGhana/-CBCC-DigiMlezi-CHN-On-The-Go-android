...
public class DownloadCourseListAdapter extends ArrayAdapter<CourseIntallViewAdapter> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView  = inflater.inflate(R.layout.course_download_row_oppia, parent, false);
        ...
        if (c.isDownloading() || c.isInstalling()){
            viewHolder.actionBtn.setImageResource(R.drawable.ic_cancel_grey_500_24dp);
            ...
            if(c.isInstalled()){
                if(c.isToUpdate()){
                    ...
                    viewHolder.actionBtn.setImageResource(R.drawable.ic_check_circle_grey_500_24dp);
                    viewHolder.actionBtn.setContentDescription(installedDescription);
                    viewHolder.actionBtn.setEnabled(false);
                }
            } else {
                viewHolder.actionBtn.setImageResource(R.drawable.ic_file_download_grey_500_24dp);
