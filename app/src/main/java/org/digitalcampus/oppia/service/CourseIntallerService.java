...
public class CourseIntallerService extends IntentService {
    ...
    private void installDownloadedCourse(String fileUrl, String shortname, Double versionID) {
        ...
        try {
            courseXMLPath = tempdir + File.separator + courseDirs[0] + File.separator + org.digitalcampus.oppia.application.MobileLearning.COURSE_XML;
            courseScheduleXMLPath = tempdir + File.separator + courseDirs[0] + File.separator + org.digitalcampus.oppia.application.MobileLearning.COURSE_SCHEDULE_XML;
            courseTrackerXMLPath = tempdir + File.separator + courseDirs[0] + File.separator + org.digitalcampus.oppia.application.MobileLearning.COURSE_TRACKER_XML;
        ...
        } catch (org.digitalcampus.oppia.exception.InvalidXMLException e) {
    ...
    */
    ...
    private boolean downloadCourseFile(String fileUrl, String shortname, Double versionID){
        ...
        try {
        	...
        	CbccUser u = db.getUser(SessionManager.getUsername(this));
        ...
        try {
            ...
            if (response.isSuccessful()){
                ...
                for (int i = 0; i < (schedule.length()); i++) {
                    ...
                    DateTime sdt = org.digitalcampus.oppia.application.MobileLearning.DATETIME_FORMAT.parseDateTime(acts.getString("start_date"));
                    DateTime edt = org.digitalcampus.oppia.application.MobileLearning.DATETIME_FORMAT.parseDateTime(acts.getString("end_date"));
                    as.setStartTime(sdt);
                    as.setEndTime(edt);
            ...
            removeDownloading(scheduleUrl);
        } catch (org.digitalcampus.oppia.exception.UserNotFoundException | IOException e) {
            sendBroadcast(scheduleUrl, ACTION_FAILED, getString(R.string.error_connection));
            removeDownloading(scheduleUrl);
        }
