...
public class RegisterTask extends APIRequestTask<Payload, Object, Payload> {
    ...
    public RegisterTask(Context ctx, org.digitalcampus.oppia.api.ApiEndpoint api) { super(ctx, api); }
	...
	protected Payload doInBackground(Payload... params) {
		...
		try {
            ...
            Request request = new Request.Builder()
                    .url(apiEndpoint.getFullURL(ctx, org.digitalcampus.oppia.application.MobileLearning.REGISTER_PATH))
            ...
            if (response.isSuccessful()){
                ...
                org.digitalcampus.oppia.application.DbHelper db = org.digitalcampus.oppia.application.DbHelper.getInstance(ctx);
